module github.com/hatayama/unity-cli-loop/tools/release-automation

go 1.26

require (
	github.com/hatayama/unity-cli-loop/common v0.0.0-00010101000000-000000000000
	github.com/hatayama/unity-cli-loop/dispatcher v0.0.0-00010101000000-000000000000
)
...
replace github.com/hatayama/unity-cli-loop/dispatcher => ../dispatcher
