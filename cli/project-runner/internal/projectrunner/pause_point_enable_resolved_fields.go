...
// enablePausePointPropagatedFields carries enable-time resolution fields into the --await hit
// and Expired responses, matching how Warning alone used to be forwarded from
...
// Why Method/SnapshotTiming/LineBasis always from enable: the Unity status DTO still does not
// carry them.
func mergeEnablePausePointResolvedFields(
	...
	response.LineBasis = enableFields.LineBasis
	return response
}
