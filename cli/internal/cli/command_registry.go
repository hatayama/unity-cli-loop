...
var nativeCommands = []nativeCommandEntry{
	...
	{name: "wait-for-pause-point", description: "Wait until a named UloopPausePoint.Pause marker pauses Unity"},
	{name: "pause-point-status", description: "Show the state of a named UloopPausePoint.Pause marker"},
