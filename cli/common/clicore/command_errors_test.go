...
func TestAvailableCommandNamesIncludesBuiltIns(t *testing.T) {
	...
	expectedBuiltIns := []string{"launch", "list", "sync", "focus-window", "await-pause-point", "pause-point-status", "enable-watch", "clear-watch", "get-watch-values", "skills", "completion", "install", "update", "uninstall"}
