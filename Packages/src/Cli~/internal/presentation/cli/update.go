...
import (
	...
	sharedversion "github.com/hatayama/unity-cli-loop/Packages/src/Cli/internal/version"
)
...
func updateScriptVersion(options updateOptions) string {
	...
	return clicontract.Current.CliVersion
}
...
func updateSelector(options updateOptions) string {
	...
	return installer.UpdateSelectorForVersion(clicontract.Current.CliVersion)
}
