...
func TestCollectSkillDefinitionsIncludesCliOnlyAndSkipsInternal(t *testing.T) {
	...
	writeTestSkill(t, projectRoot, "Packages/src/Cli~/internal/presentation/skill-definitions/cli-only/uloop-launch/Skill", `---
name: uloop-launch
---

# uloop launch
`)
	writeTestSkill(t, projectRoot, "Packages/src/Cli~/internal/presentation/skill-definitions/cli-only/uloop-internal/Skill", `---
name: uloop-internal
internal: true
---
