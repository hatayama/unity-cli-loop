...
* Add TypeScript paths to Security Code Scan workflow triggers ([#736](https://github.com/hatayama/unity-cli-loop/issues/736)) ([44e6a3d](https://github.com/hatayama/unity-cli-loop/commit/44e6a3da34f8c80c5d3f7ffd82ec80b7133eab5c))
...
* Beta release recovery no longer blocks the next release PR ([#1083](https://github.com/hatayama/unity-cli-loop/issues/1083)) ([7891b59](https://github.com/hatayama/unity-cli-loop/commit/7891b59886e53dee94f2c872aba0640c2bac4843))
* Beta releases no longer get blocked by stale release PRs ([#1085](https://github.com/hatayama/unity-cli-loop/issues/1085)) ([975d16a](https://github.com/hatayama/unity-cli-loop/commit/975d16a5768149634e322173a2722d5240da2b6b))
...
* **ci:** Remove npm global upgrade that broke npm publish ([#890](https://github.com/hatayama/unity-cli-loop/issues/890)) ([cb0af8d](https://github.com/hatayama/unity-cli-loop/commit/cb0af8d4d1c361ae0305f0d56ee6ea1f820a5f33))
* **ci:** restore NPM_TOKEN authentication for npm publish ([#900](https://github.com/hatayama/unity-cli-loop/issues/900)) ([9b59e4a](https://github.com/hatayama/unity-cli-loop/commit/9b59e4a4f6a89e06e9c28a456e4d3d33fc47e381))
* **ci:** Upgrade to Node.js 24 for npm OIDC trusted publishing ([#893](https://github.com/hatayama/unity-cli-loop/issues/893)) ([a8322f6](https://github.com/hatayama/unity-cli-loop/commit/a8322f67c2554e841fdf4f7811f933b2ffcb7045))
* **ci:** Use OIDC trusted publishing instead of NPM_TOKEN ([#891](https://github.com/hatayama/unity-cli-loop/issues/891)) ([f38712f](https://github.com/hatayama/unity-cli-loop/commit/f38712f6eeda2ecfa7eecbfca81aa90b0046d1de))
...
* Correct npm script name in Security Code Scan workflow ([#737](https://github.com/hatayama/unity-cli-loop/issues/737)) ([2662128](https://github.com/hatayama/unity-cli-loop/commit/26621280b350759d746c890293ceb61e42ebc2c9))
...
* decouple npm publish from release-please to fix missing CLI v1.0.0 ([#776](https://github.com/hatayama/unity-cli-loop/issues/776)) ([d3367fc](https://github.com/hatayama/unity-cli-loop/commit/d3367fcdb15df1e557976abfc02f1e0e7b5a7575))
...
* keep EditMode tests from freezing the editor ([#942](https://github.com/hatayama/unity-cli-loop/issues/942)) ([75798ed](https://github.com/hatayama/unity-cli-loop/commit/75798ed10968d888d62af50935d4b918804e21a7))
...
* Native CLI releases now publish only after assets are verified ([#1056](https://github.com/hatayama/unity-cli-loop/issues/1056)) ([a442c3e](https://github.com/hatayama/unity-cli-loop/commit/a442c3e07f7797daa860e1b54b88620046f2769c))
* Native prereleases recover after failed publishing ([#1078](https://github.com/hatayama/unity-cli-loop/issues/1078)) ([204e9be](https://github.com/hatayama/unity-cli-loop/commit/204e9be1cc997fa9d160527fed34c7acdb4e7d21))
* Native releases now stop mismatched beta and stable publishes ([#1059](https://github.com/hatayama/unity-cli-loop/issues/1059)) ([4073dd4](https://github.com/hatayama/unity-cli-loop/commit/4073dd4f8bdea7c7437d400e44d9f4a6cf9c051a))
...
* Release PRs only open after main updates ([#1021](https://github.com/hatayama/unity-cli-loop/issues/1021)) ([89abd28](https://github.com/hatayama/unity-cli-loop/commit/89abd285090933f43d8681092d15d8666954e7f6))
...
* restore npm publish in release-please workflow ([#777](https://github.com/hatayama/unity-cli-loop/issues/777)) ([c15d51b](https://github.com/hatayama/unity-cli-loop/commit/c15d51bb9b4584073988cdfb73a49da1a94b7765))
...
* restore server bundle rebuild step in release-please workflow ([#617](https://github.com/hatayama/unity-cli-loop/issues/617)) ([d8ff9e0](https://github.com/hatayama/unity-cli-loop/commit/d8ff9e03efdb3974e6c37b29bf298d3889c3aac3))
...
* **skills:** improve execute-dynamic-code description for better task matching ([#522](https://github.com/hatayama/unity-cli-loop/issues/522)) ([b05e0c1](https://github.com/hatayama/unity-cli-loop/commit/b05e0c159093b89f5fbfc8f4faa44c27107e811f))
* **skills:** update execute-dynamic-code skill documentation ([#521](https://github.com/hatayama/unity-cli-loop/issues/521)) ([719fd65](https://github.com/hatayama/unity-cli-loop/commit/719fd65b1a7e778bd914ab17a14ce135996be863))
...
* **test:** convert UnitySearchToolTests to synchronous execution ([#519](https://github.com/hatayama/unity-cli-loop/issues/519)) ([3078dd2](https://github.com/hatayama/unity-cli-loop/commit/3078dd2933c71270d57a1affaea1824afa976b3f))
...
* use NPM_TOKEN for npm publish in non-release-please workflows ([#778](https://github.com/hatayama/unity-cli-loop/issues/778)) ([fd6cfae](https://github.com/hatayama/unity-cli-loop/commit/fd6cfae4463efd57710996350214ca10613ff4fc))
