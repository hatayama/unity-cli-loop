...
## [2.3.0](https://github.com/hatayama/unity-cli-loop/compare/v2.2.0...v2.3.0) (2026-07-28)
...
* Codex no longer fails to load its config after uLoopMCP rewrites a `codex mcp add` entry ([#1930](https://github.com/hatayama/unity-cli-loop/issues/1930)) ([2b1c235](https://github.com/hatayama/unity-cli-loop/commit/2b1c235537fe46626b71ec3d67274c9c02ca22aa))
* Document that --force-recompile is rarely needed in compile skill ([#1973](https://github.com/hatayama/unity-cli-loop/issues/1973)) ([62f5e4f](https://github.com/hatayama/unity-cli-loop/commit/62f5e4f8e752dc98234fcef5e2fc92ba43c303cf))
...
* prevent cross-project Unity connections from stale ports ([#1844](https://github.com/hatayama/unity-cli-loop/issues/1844)) ([f31d2c9](https://github.com/hatayama/unity-cli-loop/commit/f31d2c95ab632340912b0429fc5c3c0ebebe9550))
...
* Resolve npm audit vulnerabilities in the TypeScript MCP server ([#1949](https://github.com/hatayama/unity-cli-loop/issues/1949)) ([009155b](https://github.com/hatayama/unity-cli-loop/commit/009155b953e84dc42a4408bfed6ef6bdf4527d9b))
