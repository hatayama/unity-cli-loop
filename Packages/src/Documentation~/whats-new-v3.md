...
- **Installer authenticity verification** — release assets carry sigstore attestations, and the installer verifies the downloaded archive against the digests pinned in the repository before running anything.
