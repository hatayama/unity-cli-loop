...
{
    internal static class ThirdPartyToolMigrationTimingMethodBodyRules
    {
        internal static (int StartIndex, int EndIndex) FindMethodImplementationUsageRange(
            string source,
        ...
        internal static int FindBlockClosingBraceIndex(
            string source,
            CodeTextMask codeTextMask,
            int openBraceIndex)
        {
        ...
        internal static int FindExpressionBodiedMemberSemicolonIndex(
            string source,
            CodeTextMask codeTextMask,
            int startIndex)
        {
