...
namespace io.github.hatayama.UnityCliLoop.FirstPartyTools
{
    ...
    internal sealed class HotReloadTypeHome
    {
        ...
        /// <summary>
        /// Whether a publicized copy of this home's image may be built. A retained artifact
        /// qualifies as well as a project assembly: a shim compiled for an edited body of a type
        /// the artifact holds reaches that type's private members, and the shim is an assembly of
        /// its own, so it can only see them through a publicized copy. Engine and system
        /// assemblies are the ones that must never be rewritten, and neither kind names one.
        /// </summary>
        public bool IsPublicizable =>
            Kind == HotReloadTypeHomeKind.ScriptAssemblies || Kind == HotReloadTypeHomeKind.RetainedArtifact;
