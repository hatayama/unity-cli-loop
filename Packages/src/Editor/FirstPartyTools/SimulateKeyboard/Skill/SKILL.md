...
4. If the screenshot cannot prove the gameplay state, place and arm a `UnityCliLoopDebug.Break("<id>")` marker after the input-handling path, run the input again, then inspect while Unity is paused
