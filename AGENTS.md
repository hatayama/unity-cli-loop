...
On Windows, an abrupt dispatcher exit or `UNITY_NOT_REACHABLE` can be Microsoft Defender quarantining `uloop.exe` rather than an IPC problem; the verification and recovery procedure is in `docs/windows-compatibility.md`.
