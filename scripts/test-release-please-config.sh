...
assert_json_value '.packages["cli"].["exclude-paths"][0]' 'cmd/dispatch-release-please-pr-checks'
assert_json_value '.packages["cli"].["exclude-paths"][1]' 'internal/automation'
