...
build_binary darwin arm64 uloop "$CORE_DIR" ./cmd/uloop
build_binary darwin amd64 uloop "$CORE_DIR" ./cmd/uloop
build_binary windows amd64 uloop "$CORE_DIR" ./cmd/uloop
