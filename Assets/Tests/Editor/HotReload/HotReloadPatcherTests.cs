...
namespace io.github.hatayama.UnityCliLoop.Tests.Editor.HotReload
{
    ...
    public class HotReloadPatcherTests
    {
        ...
        public void RevertAll_ClearsAddedFieldStore()
        {
            ...
            Assert.That(HotReloadTranspilerDomainGateway.Current.GetAddedFieldsForType("Host"), Is.Empty);
        }
        ...
        public void RevertAll_RunsTheDomainStoreReset()
        {
            ...
            Assert.That(HotReloadTranspilerDomainGateway.Current.DescribeAddedFields(), Is.Empty);
        }
