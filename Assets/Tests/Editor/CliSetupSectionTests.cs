...
namespace io.github.hatayama.UnityCliLoop.Tests.Editor
{
    ...
    public class CliSetupSectionTests
    {
        ...
        [TestCase(true, false, false, true, false, true, false, "3.0.0", "3.0.0", "Update CLI (protocol v2)")]
        [TestCase(true, false, false, false, true, true, false, "3.1.0", "3.0.0", "Downgrade CLI (v3.1.0 \u2192 v3.0.0)")]
        [TestCase(true, false, false, false, true, true, false, "3.0.0", "3.0.0", "Downgrade CLI (protocol v2)")]
